      ...
      <div className="max-w-7xl mx-auto px-4 w-full">
        <div className="grid grid-cols-5 gap-6 items-center">
          ...
          <div className="col-span-5 md:col-span-3">
            <h2 className="text-5xl  text-gray-800 mb-3">
          ...
          <div className="col-span-5 mx-4 bg-black md:col-span-2  relative h-full">
            ...
            <div className="relative bg-white bg-opacity-50 m-2 text-black  h-[470px] flex flex-col items-center px-6 py-10 text-center space-y-6">
              {/* Title */}
              <h3 className="text-2xl pt-3 font-semibold">Sky Hotel</h3>

              {/* Stars */}
              <div className="flex justify-center pt-14  space-x-1">
                {Array(5)
                  .fill(0)
                  .map((_, i) => (
                    <svg
              ...
              {/* Subtitle */}
              <h4 className="text-lg pt-5 font-bold">Luxury Hotel</h4>
